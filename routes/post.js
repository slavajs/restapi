...
const postController = require("../controllers/post");const express = require("express");
...
router.delete("/post/delete/:postId", isAuth, isCreator, postController.deletePost);
